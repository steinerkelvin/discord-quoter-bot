...
(function() {
  var App, CHANNEL_STRING, DISCRIMINATOR_STRING, Discord, EMPTY_MESSAGE_STRING, IMAGE_EXTENSIONS, SERVER_STRING, SHOW_USER_DISCRIMINATOR, bot, get_env, get_env_check, idt, isImage, isTrue, lg, lgErr, moment, ref, ref1, ref2, ref3, strNumberToSubscript, vars,
  ...
  EMPTY_MESSAGE_STRING = (ref1 = vars.EMPTY_MESSAGE_STRING) != null ? ref1 : "";
  ...
  if ((ref3 = vars.LOCALE) === 'pt' || ref3 === 'pt-BR') {
    SERVER_STRING = "@ ";
  }
  ...
  App = (function() {
    function App(vars1) {
      ...
      this.prefix = (ref4 = this.vars.PREFIX) != null ? ref4 : "$";
    ...
    App.prototype.do_quote = function(message, args, cite, edit) {
      ...
      return channel.fetchMessages({
        ...
        return function(qt_msg) {
          var author_name, color, discriminator, err_msg, member, opts, ref4, res_text, showGuild;
          qt_msg = qt_msg.first();
          if (!qt_msg) {
          ...
          if (channel.guild) {
            ...
            color = (ref4 = member.highestRole) != null ? ref4.color : void 0;
          ...
          if (SHOW_USER_DISCRIMINATOR && (discriminator = qt_msg.author.discriminator)) {
          ...
          (qt_msg.attachments.some(function(attachment, id) {
            ...
            var ref5, url;
            if ((url = embed != null ? (ref5 = embed.thumbnail) != null ? ref5.url : void 0 : void 0)) {
              opts.embed.image.url = url;
              return true;
            }
          }));
          res_text || (res_text = EMPTY_MESSAGE_STRING);
          if (edit) {
