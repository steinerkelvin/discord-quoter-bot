...
(function() {
  var App, CHANNEL_STRING, Discord, IMAGE_EXTENSIONS, bot, get_env, get_env_check, isImage, lg, lgErr, moment, ref, ref1, vars,
  ...
  ref = require('./util'), get_env = ref.get_env, get_env_check = ref.get_env_check;
  ...
  App = (function() {
    ...
    App.prototype.init_user_bot = function() {
      ...
      this.client.on('messageUpdate', this.handle_message);
    ...
    App.prototype.build_message_footer = function(message, showGuild) {
      ...
      if (showGuild && (guild = channel != null ? channel.guild : void 0)) {
        footer.push("\#" + (guild != null ? guild.name : void 0));
      }
    ...
    App.prototype.do_quote = function(message, args, cite, edit) {
      ...
      return channel.fetchMessages({
        ...
        return function(qt_msg) {
          var author_name, color, err_msg, footer, member, name, opts, ref2, res_text, showGuild, timestamp;
          qt_msg = qt_msg.first();
          if (!qt_msg) {
          ...
          if (channel.guild) {
            ...
            color = (ref2 = member.highestRole) != null ? ref2.color : void 0;
          ...
          if ((name = channel.name)) {
            footer.push(CHANNEL_STRING + ("\#" + channel.name));
          }
